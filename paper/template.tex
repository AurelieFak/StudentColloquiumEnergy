...
% AURELIE COMMENT :
We aim at answering many questions in our paper, many deicisons has to be made when designing such systems : \\
...
% In this part four surveys and their results will be presented. The surveyx can be divided in two parts: the ones who try to define the users wished and the ones where the users compared different design components
% User-wishes surveys
% Protoypes surveys
