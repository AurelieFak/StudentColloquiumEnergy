...
% Some of them are theorical, while others are made in real situations or with real protoypes. Using different methods and approaches will allow us to have a better insight and a user-centered approach BLABLABLA
...
% Interviews
% Because who else than the users know what is good for them ? It allows the researches to really understand what can affect and impact the user behavior
...
% MOTIVATION Targetting young people could be more efficient because it's problably easier for them to change their bad habits and we have a lot of tools such as apps to make them are, technology + young people is a good match, they use their smartphones really often, games etc. Maybe it could be a new target, new perpsective, new approach compared to the ones you'll find in this paper and the one present in the litterature, new oppotunities with young people
